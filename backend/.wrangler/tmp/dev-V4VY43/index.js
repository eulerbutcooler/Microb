...
// .wrangler/tmp/bundle-1zcosm/checked-fetch.js
...
var require_edge2 = __commonJS({
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      ...
      "inlineSchemaHash": "f205c3f1cd2ca4c256524c52c6195dc6a46f738f0a00c5f00afdb50faab949b7",
      "copyEngine": false
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-1zcosm/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-1zcosm/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
async function signup(c) {
  ...
  try {
    ...
    const data = encoder.encode(validated.data.password);
