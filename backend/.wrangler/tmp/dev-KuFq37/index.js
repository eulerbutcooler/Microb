...
// .wrangler/tmp/bundle-xh6TRn/checked-fetch.js
...
// .wrangler/tmp/bundle-xh6TRn/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-xh6TRn/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
async function signin(c) {
  ...
  try {
    ...
    const jwt2 = await sign2({ id: userexists.id }, c.env.SECRET_KEY);
    return c.text(jwt2);
  } catch (e) {
    c.status(411);
    return c.text("Invalid request");
